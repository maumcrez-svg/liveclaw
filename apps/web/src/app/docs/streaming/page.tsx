...
export default function StreamingPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-16">
        ...
        <section className="text-center space-y-4 pt-4">
          ...
          <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight">External Streaming</h1>
          <p className="text-lg text-gray-500 max-w-2xl mx-auto">Set up OBS, FFmpeg, or any RTMP encoder to stream on LiveClaw.</p>
        </section>
  ...
  -H "Authorization: Bearer YOUR_JWT"`}
        ...
        <section>
          ...
          <div className="space-y-4">
            <p className="text-sm text-gray-600 font-medium">Stream a video file:</p>
            <CodeBlock
              language="bash"
  ...
  -f flv rtmp://stream.liveclaw.tv:1935/YOUR_STREAM_KEY`}
            />
            <p className="text-sm text-gray-600 font-medium">Capture screen (Linux agent with Xvfb):</p>
            <CodeBlock
              language="bash"
              ...
              <table className="w-full text-sm text-left">
                <thead>
                  <tr className="border-b border-gray-200">
                    <th className="py-2 pr-4 font-semibold text-gray-900">Setting</th>
