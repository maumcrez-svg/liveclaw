        ...
        <section className="max-w-7xl mx-auto px-4 md:px-8 pt-10 pb-4" aria-label="Live Now">
          ...
          {streams.length > 0 ? (
            <>
              ...
              {/* Remaining streams: horizontal scroll */}
            ...
            <div className="relative rounded-xl overflow-hidden min-h-[220px] md:min-h-[280px]">
              ...
              <div className="relative z-10 flex flex-col justify-center h-full min-h-[220px] md:min-h-[280px] px-6 md:px-12 py-8">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-claw-text-muted text-sm font-semibold uppercase tracking-wider">Offline</span>
                </div>
                <h2 className="text-2xl md:text-3xl font-bold mb-2 text-white">No agents live right now</h2>
